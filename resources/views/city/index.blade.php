...
@section('content')
    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
        ...
        <ul class="breadcrumb mb-1">
            ...
            <li><a class="text-muted" href="{{ route('city.index') }}"></a></li>
        </ul>
    </div>
    <form method="GET">
        <div class="row mt-2">
            ...
            <div class="col-md-3">
                <div class="input-group width-100" style="width: 100%">
                    ...
                    <select name="state_id" id="state" class="js-example-basic-single select2 form-control">
            ...
            <div class="col-md-3 text-right">
                <div class="btn-group">
                    ...
                    @if (hasPermission('city-create', $slugs))
                    <a class="btn btn-sm btn-theme" data-toggle="tooltip" data-placement="top" title="Add New" href="{{ route('city.create') }}" class="btn btn-sm btn-black" style="height: 33px; line-height: 22px; border-top-left-radius: 2px; border-bottom-left-radius: 2px">
    ...
    <div class="row mt-2">
        <div class="col-md-12">
                ...
                <tbody>
                    @forelse ($cities as $city)
                        <tr>
                            ...
                            <td>{{ $city->name }}</td>
                            <td><a href="{{ route('state.index') }}">{{ optional($city->state)->name }}</a></td>
                            <td>
                            ...
                            <td class="text-center">
                                <x-status status="{{ $city->status }}" id="{{ $city->id }}" table="{{ $table }}" />
                            </td>
                            ...
                            <td class="text-center">
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-right">
                                        @if (hasPermission('city-edit', $slugs))
                                        <li>
                                            <a href="{{ route('city.edit', $city->id) }}" title="Edit">
                                                <i class="far fa-edit"></i> Edit
                                            </a>
                                        </li>
                                        @endif
                                        @if (hasPermission('city-delete', $slugs))
                                        <li>
                                            <a href="javascript:void(0)" title="Delete" onclick="delete_item('{{ route('city.destroy', $city->id) }}')" type="button">
            ...
            @include('partials._paginate', ['data' => $cities])
        </div>
    </div>
@endsection
