            ...
            <div class="widget-box">
                ...
                <div class="widget-body">
                    <div class="widget-main">
                        <form class="form-horizontal" action="{{ route('ua.permission-access.update', $users->id) }}" method="post"
                            role="form">
                            @csrf
                            @method('put')
                            ...
                            <div class="row">
                              ...
                              <div class="row pt-3">
                                    ...
                                    <div class="col-md-4">
                                        <div class="input-group width-100" style="width: 100%">
                                            ...
                                            <input type="text" class="form-control" name="user_id"
                                                value="{{  $users->first_name." ".$users->last_name }}" required>
                                            {{-- <select class="form-control select2" id="select-new-employee-id" onchange="loadEmployeeInfo(this)" name="user_id">
                               ...
                               {{-- @else
                                    <div class="col-md-4" style="height: 40px;">
                                        <div class="input-group" style="width:100%">
                                            <label class="input-group-addon" style="width:130px; text-align:left"> Role Name </label>
                                            <select class="chosen-select-280 form-control" id="select-new-employee-id" onchange="loadEmployeeInfo(this)" name="role_id">
                            ...
                            <div class="access-control">
                                                                ...
                                                                <div class="row order-type" style="margin-top:10px">
                                                                    <table class="table table-striped table-sm mx-auto"
                                                                        ...
                                                                        <tbody>
                                                                            ...
                                                                            @foreach ($submodule->parentPermissions as $in => $parent_permissions)
                                                                                <tr>
                                ...
                                <div class="form-group pull-right" style="margin-top:14px">
                                    ...
                                    <a href="{{ route('ua.admin.index') }}" class="btn btn-sm  btn-info"> <i
...
@section('js')
    ...
    {{-- <script type="text/javascript">
        ...
        $('.existing_employee').change(function() {
            var id = $(this).val();
            let text = `/ua/permission-access/create/${id}`
