            ...
            <div class="widget-box">
                ...
                <div class="widget-body">
                    <div class="widget-main">
                        <form class="form-horizontal" action="{{ route('ua.permission-access.store') }}" method="POST"
                            role="form">
                            @csrf
                            ...
                            <div class="row pt-3">
                                ...
                                {{-- <div class="col-md-4" style="height: 40px;"> --}}
                                    ...
                                    {{-- <div class="input-group" style="width:100%">
                                        ...
                                        <select class="chosen-select-2 "    style="width:130px;" name="user_id" required>
                                    ...
                                    <div class="col-md-4">
                                        <div class="input-group width-100" style="width: 100%">
                                            ...
                                            <select name="user_id" class="form-control select2" width="100%" required>
                                    ...
                                    {{-- @else --}}
                                        {{-- <div class="input-group" style="width:100%">
                                            ...
                                            <select class="chosen-select-280 form-control" id="select-new-employee-id" onchange="loadEmployeeInfo(this)" name="role_id" required> --}}
                                                {{-- <option value=""> -- select -- </option> --}}
...
@section('js')
    ...
    {{-- <script type="text/javascript">
        ...
        $('.existing_employee').change(function() {
            var id = $(this).val();
            let text = `/user-acces/permission-access/create/${id}`
