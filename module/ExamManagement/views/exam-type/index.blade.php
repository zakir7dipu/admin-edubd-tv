...
@section('content')
            ...
            <div class="col-md-4 text-right">
                <div class="btn-group">
                    ...
                    <a class="btn btn-sm btn-theme" data-toggle="tooltip" data-placement="top" title="Add New"
                        href="{{ route('em.exam-types.create') }}" class="btn btn-sm btn-black"
    ...
    <div class="row mt-2">
        <div class="col-md-12">
            ...
            <table id="myTable" class="table table-bordered">
                <thead style="border-bottom: 3px solid #346cb0 !important">
                    <tr style="background: #e1ecff !important; color:black !important">
                        ...
                        <th class="text-center" width="10%">Slug</th>
                ...
                <tbody>
                    @forelse ($examTypes as $examType)
                        <tr>
                            ...
                            <td>
                                <a href="{{ $examType->slug }}" target="_blank">
                                    {{ $examType->type }}
                                </a>
                            </td>
                            ...
                            <td class="text-center">
                                <x-status status="{{ $examType->status }}" id="{{ $examType->id }}"
                                    table="{{ $table }}" />
                            </td>
                            <td class="text-center">
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-right">
                                        <li>
                                            <a href="{{ route('em.exam-types.edit', $examType->id) }}" title="Edit">
                                                <i class="far fa-edit"></i> Edit
                                            </a>
                                        </li>
                                        <li>
                                            <a href="javascript:void(0)" title="Delete"
                                                onclick="delete_item('{{ route('em.exam-types.destroy', $examType->id) }}')"
                                                type="button">
            ...
            @include('partials._paginate', ['data' => $examTypes])
        </div>
    </div>
@endsection
