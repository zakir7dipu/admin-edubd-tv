...
@section('content')
    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
        ...
        <ul class="breadcrumb mb-1">
            ...
            <li><a class="text-muted" href="{{ route('em.exam-types.index') }}">Exam Type</a></li>
            <li class=""><a href="javascript:void(0)">Create</a></li>
        </ul>
    </div>
    @include('partials._alert_message')

    <form action="{{ route('em.exam-types.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="row mt-2">
            <div class="col-md-6">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-12 col-md-9">
                        <input type="text" class="form-control" name="type" value="{{ old('type') }}" required id="name">
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-12 col-md-3 col-form-label">Exam Slug<sup style="color: red">*</sup></label>
                    <div class="col-sm-12 col-md-9">
