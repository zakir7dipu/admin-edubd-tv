...
@section('content')
    ...
    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
        ...
        <ul class="breadcrumb mb-1">
            ...
            <li><a class="text-muted" href="{{ route('wc.support.index') }}">Support </a></li>
        </ul>
    </div>


    <form action="{{ route('wc.support.update', $support->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
            ...
            <div class="col-md-12">
                <div class="form-group row">
                    ...
                    <div class="col-sm-12 col-md-12">
                        <textarea name="description" class="form-control ckeditor" rows="4">{{ old('description', $support->description) }}</textarea>
                    </div>
                </div>
