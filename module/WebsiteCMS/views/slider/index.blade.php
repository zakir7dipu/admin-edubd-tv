...
@section('content')
        ...
        <div class="row mt-2">
            ...
            <div class="col-md-4 text-right">
                <div class="btn-group">
                    ...
                    @if(hasPermission("slider-create", $slugs))
                    <a class="btn btn-sm btn-theme" data-toggle="tooltip" data-placement="top" title="Add New" href="{{ route('wc.sliders.create') }}" class="btn btn-sm btn-black" style="height: 33px; line-height: 22px; border-top-left-radius: 2px; border-bottom-left-radius: 2px">
    ...
    <div class="row mt-2">
        <div class="col-md-12">
                ...
                <tbody>
                    @forelse ($sliders as $slider)
                        <tr>
                            ...
                            <td>
                                <img src="{{ asset($slider->image) }}" width="100%" height="100px" alt="">
                            </td>
                            <td class="text-center">{{ $slider->serial_no }}</td>
                            <td class="text-center">
                                <x-status status="{{ $slider->status }}" id="{{ $slider->id }}" table="{{ $table }}" />
                            </td>
                            <td class="text-center">
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-right">
                                        @if(hasPermission("slider-edit", $slugs))
                                        <li>
                                            <a href="{{ route('wc.sliders.edit', $slider->id) }}" title="Edit">
                                                <i class="far fa-edit"></i> Edit
                                            </a>
                                        </li>
                                        @endif
                                        @if(hasPermission("slider-delete", $slugs))
                                        <li>
                                            <a href="javascript:void(0)" title="Delete" onclick="delete_item('{{ route('wc.sliders.destroy', $slider->id) }}')" type="button">
            ...
            @include('partials._paginate', ['data' => $sliders])
        </div>
    </div>
@endsection
