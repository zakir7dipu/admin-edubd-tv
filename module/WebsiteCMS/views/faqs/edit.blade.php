...
@section('content')
    ...
    <form action="{{ route('wc.faqs.update', $faq->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="row mt-2">
            <div class="col-md-6">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-12 col-md-9">
                        <textarea name="description" class="form-control" rows="2">{{ old('description', $faq->description) }}</textarea>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group row">
                    ...
                    <div class="col-sm-12 col-md-9">
                        <input type="text" name="serial_no" class="form-control only-number"
                            value="{{ old('serial_no', $faq->serial_no) }}" autocomplete="off" required>
                    </div>
                </div>
                <div class="form-group row">
