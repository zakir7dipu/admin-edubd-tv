...
@section('content')
    ...
    <form action="{{ route('wc.testimonials.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <div class="row mt-2">
            ...
            <div class="col-md-6">
                ...
                <div class="form-group row">
                    <label class="col-sm-12 col-md-3 col-form-label">Rating <sup style="color: red"></sup></label>
                    <div class="col-sm-12 col-md-9">
