<script>
    ...
    const fetchLesson = async (obj) => {

        let lessonId = $(obj).find('option:selected').val();
        let oldLessonId = `{{ old('lesson_id') }}` != undefined ? `{{ old('lesson_id') }}` : null;
