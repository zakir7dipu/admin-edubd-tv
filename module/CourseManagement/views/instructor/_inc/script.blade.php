...
<script>
    ...
    const removeSocialLink = (obj) => {
        $(obj).closest('.socialLink').remove();
    }
    ...
    const addSocialLink = () => {
        const socialLink =   `<div class="row socialLink mb-1">
                                <div class="col-sm-12 col-md-9">
                                    <div class="row">
                                        <div class="col-sm-12 col-md-3">
                                            <div class="input-group">
                                                <label class="input-group-addon" style="background: #dfdfdf; color: #000000">Name <span style="color: red">*</span></label>
                                                <input type="text" class="form-control" name="socialName[]" autocomplete="off" required>
                                            </div>
                                        </div>
                                        <div class="col-sm-12 col-md-3">
                                            <div class="input-group">
                                        ...
                                        <div class="col-sm-12 col-md-3">
                                            <div class="input-group">
                                                ...
                                                <input type="color" class="form-control" name="background_color[]" autocomplete="off" >
                                            </div>
                                        </div>
                                        <div class="col-sm-12 col-md-3">
                                            <div class="input-group">
                                                <label class="input-group-addon" style="background: #dfdfdf; color: #000000">Foreground Color <span style="color: red">*</span></label>
                                                <input type="color" class="form-control" name="foreground_color[]" autocomplete="off" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        $('#instructorSocialLink').append(socialLink);
    }
</script>
