...
@section('content')
    ...
    <form action="{{ route('cm.instructors.update', $instructor->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="row mb-2">
            <div class="col-md-6">
                <div class="form-group row">
                    ...
                    <div class="col-sm-12 col-md-8">
                        <input type="text" class="form-control" name="first_name" value="{{ old('first_name', $instructor->first_name) }}" autocomplete="off" required>
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-12 col-md-4 col-form-label">Last Name</label>
                    <div class="col-sm-12 col-md-8">
                        <input type="text" class="form-control" name="last_name" value="{{ old('last_name', $instructor->last_name) }}" autocomplete="off">
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-12 col-md-4 col-form-label">Username</label>
                    <div class="col-sm-12 col-md-8">
                        <input type="text" class="form-control" name="username" value="{{ old('username', $instructor->username) }}" autocomplete="off">
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-12 col-md-4 col-form-label">Email <sup style="color: red">*</sup></label>
                    <div class="col-sm-12 col-md-8">
                        <input type="email" class="form-control" name="email" value="{{ $instructor->email }}" disabled autocomplete="off" style="background: #dfdfdf !important; color: #000000 !important; font-weight: 500; border-color: #dfdfdf">
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-12 col-md-4 col-form-label">Phone <sup style="color: red">*</sup></label>
                    <div class="col-sm-12 col-md-8">
                        <input type="text" class="form-control" name="phone" value="{{ old('phone', $instructor->phone) }}" autocomplete="off" required>
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-12 col-md-4 col-form-label">Bio</label>
                    <div class="col-sm-12 col-md-8">
                        <textarea name="bio" class="form-control" rows="2">{{ old('bio', $instructor->bio) }}</textarea>
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-12 col-md-4 col-form-label">Experience</label>
                    <div class="col-sm-12 col-md-8">
                        <input type="text" class="form-control" name="experience" value="{{ old('experience', $instructor->experience) }}" autocomplete="off">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-12 col-md-8">
                        <select class="form-select" name="gender">
                            @foreach (genders() as $gender)
                                <option value="{{ $gender }}" {{ old('gender', $instructor->gender) == $gender ? 'selected' : '' }}>{{ $gender }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
            ...
            <div class="col-md-6">
                    ...
                    <div class="col-sm-12 col-md-8">
                        <select class="form-select select2" name="country_id" onchange="fetchStatesAndCities()" id="country_id" data-placeholder="- Select Country -" style="width: 100%">
                            ...
                            @foreach ($countries as $id => $name)
                                <option value="{{ $id }}" {{ old('country_id', $instructor->country_id) == $id ? 'selected' : '' }}>{{ $name }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-12 col-md-8">
                        <input type="text" class="form-control" name="address_1" value="{{ old('address_1', $instructor->address_1) }}" autocomplete="off" required>
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-12 col-md-4 col-form-label">Street Address 2</label>
                    <div class="col-sm-12 col-md-8">
                        <input type="text" class="form-control" name="address_2" value="{{ old('address_2', $instructor->address_2) }}" autocomplete="off">
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-12 col-md-4 col-form-label">Postcode <sup style="color: red">*</sup></label>
                    <div class="col-sm-12 col-md-8">
                        <input type="text" class="form-control only-number" name="postcode" value="{{ old('postcode', $instructor->postcode) }}" autocomplete="off" required>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-12 col-md-8">
                        <div class="material-switch" style="padding-top: 6px">
                            <input type="checkbox" name="status" id="status" value="1" {{ old('status') || $instructor->status ? 'checked' : '' }} />
                    ...
                    <div class="col-sm-12 col-md-8">
                        <div style="display: flex; align-items: center; justify-content:space-between">
                            ...
                            @if ($instructor->image != '' && file_exists($instructor->image))
                                <br><img src="{{ asset($instructor->image) }}" class="img-thumbnail img-circle" width="50px" height="50px" alt="{{ $instructor->username }}">
                            @endif
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-sm-12 col-md-10">
                        <div class="row">
                            <div id="instructorSkills">
                                ...
                                @foreach ($instructor->userSkills as $skill)
                                    <div class="col-sm-12 col-md-4 col-lg-2 mb-1 skill">
                                        <input type="text" class="form-control" name="skills[]" value="{{ $skill->name }}" style="position: relative" autocomplete="off" required>
                                        <i class="far fa-times-circle" onclick="removeSkill(this)" style="position: absolute; top: 5px; right: 17px; color: rgb(176, 0, 0); cursor: pointer"></i>
                                    </div>
                                @endforeach
                            </div>
        ...
        <div id="instructorSocialLink">
            ...
            @if(old('socialName'))
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-md-3">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" name="socialName[]" value="{{ $socialLink }}" autocomplete="off" required>
                                    </div>
                                </div>
                                <div class="col-sm-12 col-md-3">
                                    <div class="input-group">
                                ...
                                <div class="col-sm-12 col-md-3">
                                    <div class="input-group">
                                        <label class="input-group-addon" style="background: #dfdfdf; color: #000000">Background Color <span style="color: red">*</span></label>
                                        <input type="color" class="form-control" name="background_color[]" value="{{ old('background_color')[$key] }}" autocomplete="off" required>
                                    </div>
                                </div>
                                <div class="col-sm-12 col-md-3">
                                    <div class="input-group">
                ...
                @endforeach
            @endif
{{-- @dd($instructor->userSocialLink) --}}
            @foreach ($instructor->userSocialLink as $socialLink)
                <div class="row socialLink mb-1">
                    <div class="col-sm-12 col-md-9">
                        <div class="row">
                            <div class="col-sm-12 col-md-3">
                                <div class="input-group">
                                    <label class="input-group-addon" style="background: #dfdfdf; color: #000000">Name <span style="color: red">*</span></label>
                                    <input type="text" class="form-control" name="socialName[]" value="{{ $socialLink->name }}" autocomplete="off" required>
                                </div>
                            </div>
                            <div class="col-sm-12 col-md-3">
                                <div class="input-group">
                                    <label class="input-group-addon" style="background: #dfdfdf; color: #000000">Url <span style="color: red">*</span></label>
                                    <input type="text" class="form-control" name="url[]" value="{{ $socialLink->url }}" autocomplete="off" required>
                                </div>
                            </div>
                            <div class="col-sm-12 col-md-3">
                                <div class="input-group">
                                    <label class="input-group-addon" style="background: #dfdfdf; color: #000000">Bg Color <span style="color: red">*</span></label>
                                    <input type="text" class="form-control" name="background_color[]" value="{{ $socialLink->background_color }}" autocomplete="off" required>
                                </div>
                            </div>
                            <div class="col-sm-12 col-md-3">
                                <div class="input-group">
                                    <label class="input-group-addon" style="background: #dfdfdf; color: #000000">Foreground Color <span style="color: red">*</span></label>
                                    <input type="text" class="form-control" name="foreground_color[]" value="{{ $socialLink->foreground_color }}" autocomplete="off" required>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-12 col-md-3">
                        <div class="row">
                            <div class="col-sm-12 col-md-10">
                                <div class="input-group">
                                    <label class="input-group-addon" style="background: #dfdfdf; color: #000000">Icon <span style="color: red">*</span></label>
                                    <input type="text" class="form-control" name="icon[]" value="{{ $socialLink->icon }}" autocomplete="off" required>
                                </div>
                            </div>
                            <div class="col-sm-12 col-md-2">
                                <i class="far fa-times-circle" onclick="removeSocialLink(this)" style="font-size: 20px; color: red; padding-top: 7px; cursor: pointer"></i>
        ...
        <div id="instructorEducations">
            ...
            @foreach ($instructor->userEducations as $education)
                <div class="row education mb-1">
                    <div class="col-sm-12 col-md-9">
                        <div class="row">
                            <div class="col-sm-12 col-md-6">
