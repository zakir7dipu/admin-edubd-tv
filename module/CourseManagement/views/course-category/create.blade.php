...
@section('content')
    ...
    <div class="row mt-2">
        <div class="col-md-12">
            ...
            <form action="{{ route('cm.course-categories.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-12 col-md-9">
                        <textarea name="short_description" class="form-control" rows="2" autocomplete="off">{{ old('short_description') }}</textarea>
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-12 col-md-9" style="line-height: 0px">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-12 col-md-9">
                        <div class="material-switch pt-1">
                            <input type="checkbox" name="is_highlighted" id="isHighlighted" value="1" {{ old('is_highlighted') ? 'checked' : '' }} />
